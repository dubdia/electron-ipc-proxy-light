 ...
 */
function connectMainToRenderer(instance, channelPrefix = "ipc") {
    ...
    methodNames.forEach((methodName) => {
        if (typeof instance[methodName] === "function") {
            window.api.on(`${channelPrefix}:${String(methodName)}`, (event, ...args) => __awaiter(this, void 0, void 0, function* () {
